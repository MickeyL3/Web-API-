            ...
            <Paper elevation={3} sx={{ width: '100%', mt: 2, p: 2 }}>
                ...
                <Box
                    sx={{
                        ...
                        paddingBottom: "20px", // Padding to prevent the buttons from being cut off
                    }}
                >
                    ...
                    <Box
                        sx={{
                            ...
                            justifyContent: "left",
                            width: "100%",
                            flex: 1, // Allows the card content to grow and take up remaining space
                        }}
                    >
                        {games.length > 0 ? (
                            game_rows()
